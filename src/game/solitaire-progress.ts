...
export async function saveSolitaireInProgress(game: GameState, elapsedMs: number): Promise<void> {
  await store(SOLITAIRE_IN_PROGRESS_KEY, toSavedSolitaireGame(game, elapsedMs), 'local');
}
